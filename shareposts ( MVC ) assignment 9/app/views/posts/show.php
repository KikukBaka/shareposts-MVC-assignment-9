<?php require APPROOT . '/views/inc/header.php'; ?>
  <div class="row ">
      <div class="col-md-4">
          <a class="btn btn-primary pull-right" href="<?php echo URLROOT ;?>/posts"><i class="fa fa-backward"></i> Kembali</a>
      </div>
  </div>
        <div class="card mb-3 mt-2">
            ...
            <p class="card-title bg-light p-2 mb-3">
             Dibuat oleh <?php echo $data['user']->name ;?> Di <?php echo  $data['post']->created_at ;?>
            </p>
