    ...
    <div class="col-md-6 mx-auto">
        <div class="card bg-light mt-5">
            <div class="card-header card-text">
                <h2 class="card-text">Buat Akun</h2>
            <p class="card-text">Isi Form untuk mendaftar di kami (:</p>
            </div>
        
            <div class="card-body">
                <form method="post" action="<?php echo URLROOT ;?>/users/register">
                    <div class="form-group">
                        <label for="name">Nama<sub>*</sub></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="<?php echo URLROOT ;?>/users/login" class="btn btn-light btn-block pull-right">Sudah Punya Akun? Login </a>
                            </div>
                        </div>
                    </div>
                </form>
